...
void Java_org_koreatech_trizcontradiction_MainActivity_resume(JNIEnv *env, jobject obj)
{
  Q_UNUSED(env)
  Q_UNUSED(obj)
...
void Java_org_koreatech_trizcontradiction_MainActivity_pause(JNIEnv *env, jobject obj)
{
    Q_UNUSED(env)
    Q_UNUSED(obj)
...
//void Java_org_koreatech_trizcontradiction_MainActivity_backPressed(JNIEnv *env, jobject obj)
//{
//  Q_UNUSED(env)
//  Q_UNUSED(obj)
...
//void Java_org_koreatech_trizcontradiction_MainActivity_updateUser(JNIEnv *env, jobject obj,
...
//void Java_org_koreatech_trizcontradiction_MainActivity_loginMediaFinished(JNIEnv *env, jobject obj,
//                                                                        jboolean isSuccess)
//{
//    Q_UNUSED(env)
//    Q_UNUSED(obj)
...
//void Java_org_koreatech_trizcontradiction_MainActivity_logoutMediaFinished(JNIEnv *env, jobject obj,
//                                                                        jboolean isSuccess)
//{
//    Q_UNUSED(env)
//    Q_UNUSED(obj)
...
//void Java_org_koreatech_trizcontradiction_MainActivity_gcmReceivedNotice(JNIEnv *env, jobject obj, jint type, jstring msg)
//{
//  Q_UNUSED(env)
//  Q_UNUSED(obj)
...
//void  Java_org_koreatech_trizcontradiction_MainActivity_openUrlFinished(JNIEnv *env, jobject obj, jboolean isSuccess)
//{
//	Q_UNUSED(env)
//	Q_UNUSED(obj)
