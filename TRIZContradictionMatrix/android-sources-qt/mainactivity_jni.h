...
extern "C"
{
  ...
  Java_org_koreatech_trizcontradiction_MainActivity_resume(JNIEnv *env, jobject obj);

  JNIEXPORT void JNICALL
  Java_org_koreatech_trizcontradiction_MainActivity_pause(JNIEnv *env, jobject obj);
